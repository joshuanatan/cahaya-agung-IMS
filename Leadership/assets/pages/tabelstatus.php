                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="exampleModalTitle">Tambah Data STATUS</h4>
                                </div>
                                <div class="modal-body">
                                <h4 class="example-title">Kode Status</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Kode Status" disabled>
                                <h4 class="example-title">Nama Status</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="NamaStatus">
                                </div>
