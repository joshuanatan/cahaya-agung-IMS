              ...
              <div class="modal fade" id="examplePositionCenter" aria-hidden="true" aria-labelledby="examplePositionCenter"
                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                ...
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Nomor Induk Distributor" disabled>
                                ...
                                <h4 class="example-title">Kontak Distributor</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Kontak Distributor">
                                </div>
