                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="exampleModalTitle">Tambah Data ORDER</h4>
                                </div>
                                ...
                                <h4 class="example-title">Kode Barang</h4>
                                <select class="form-control" data-plugin="select2">
                                    <option value="AK"> A</option>
                                    <option value="HI"> B</option>
                                </select>
                                <h4 class="example-title">Nomor Induk Distributor</h4>
                                <select class="form-control" data-plugin="select2">
                                    <option value="AK"> C</option>
                                    <option value="HI"> D</option>
                                </select>
                                <h4 class="example-title">Tanggal Order</h4>
                                ...
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Jumlah Order">
                                </div>
