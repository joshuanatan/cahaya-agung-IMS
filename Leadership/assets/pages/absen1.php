...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <title>Absen - Inventory Management System</title>
        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          ...
          <div class="col-xxl-4">
            <div id="recentActivityWidget" class="card card-shadow card-lg pb-20" style="padding-left:10%;padding-right:10%;">
              ...
              <center><h1>ABSEN</h1></center>
              <center><h3>01 January 2019</h3>
              <button type="button" data-target="#tambahabsen" data-toggle="modal" class="btn btn-outline btn-primary float-right"><i class="icon wb-plus" aria-hidden="true"></i>ABSEN</button></center>
              

            <!-- Modal insert -->
            <div class="modal fade" id="tambahabsen" aria-hidden="true" aria-labelledby="examplePositionCenter"
              ...
              <!-- Modal edit -->
              <div class="modal fade" id="editabsen" aria-hidden="true" aria-labelledby="examplePositionCenter"
                            role="dialog" tabindex="-1">
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="checkbox-custom checkbox-primary">
                                    <input type="checkbox" id="inputUnchecked" />
                                    <label for="inputUnchecked">Saya tidak masuk</label>
                                </div>
                                <div class="checkbox-custom checkbox-primary">
                                    <input type="checkbox" id="inputChecked" checked />
                                    <label for="inputChecked">Saya masuk</label>
                                </div>
