        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          ...
          <div class="col-xxl-4">
            <div id="recentActivityWidget" class="card card-shadow card-lg pb-20" style="padding-left:10%;padding-right:10%;">
              ...
              <center><h1>ABSEN KARYAWAN</h1></center>
              <center><h3>01 January 2019</h3></center><br>
              <select class="form-control" data-plugin="select2">
                        <option value="AK">Karyawan A</option>
                        <option value="HI">Karyawan B</option>
              </select>
              <ul class="list-unstyled example">
                    <li class="mb-15">
                      ...
                      />
                      <label for="inputRadiosUnchecked"> &nbsp;Masuk</label>
                    </li>
                    <li class="mb-15">
                      <input type="radio" class="icheckbox-primary" id="inputRadiosChecked" name="inputRadios"
                        data-plugin="iCheck" data-radio-class="iradio_flat-blue"
                        checked />
                      <label for="inputRadiosChecked"> &nbsp;Tidak Masuk</label>
                    </li>
              </ul>
