              ...
              <div class="modal fade" id="examplePositionCenter" aria-hidden="true" aria-labelledby="examplePositionCenter"
                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                ...
                                <h4 class="example-title">Tempat Tanggal Lahir</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Tempat Tanggal Lahir">
                                <h4 class="example-title">Tanggal Masuk Kerja</h4>
