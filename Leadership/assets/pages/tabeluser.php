              ...
              <div class="modal fade" id="examplePositionCenter" aria-hidden="true" aria-labelledby="examplePositionCenter"
                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                ...
                                <h4 class="example-title">Kode User</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Kode User" disabled>
                                <h4 class="example-title">Nama User</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Nama User">
