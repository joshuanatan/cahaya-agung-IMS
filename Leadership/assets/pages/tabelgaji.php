        ...
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          ...
          <div class="col-xxl-4">
            <div id="recentActivityWidget" class="card card-shadow card-lg pb-20" style="padding-left:10%;padding-right:10%;">
              ...
              <button type="button" data-target="#examplePositionCenter" data-toggle="modal" class="btn btn-outline btn-primary float-right"><i class="icon wb-plus" aria-hidden="true"></i> Tambah Data</button></center>
                            ...
                            <div class="modal-dialog modal-simple modal-center">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 class="modal-title" id="exampleModalTitle">Tambah Data Gaji</h4>
                                </div>
                                <div class="modal-body">
                                <h4 class="example-title">Nomor Induk Karyawan</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="placeholder" disabled>
                                <h4 class="example-title">Gaji Per Hari</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Gaji Per Hari">
                                <h4 class="example-title">Jumlah Hari Masuk Kerja</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Jumlah Hari Masuk Kerja">
                                <h4 class="example-title">Total Gaji</h4>
                                <input type="text" class="form-control" id="inputPlaceholder" placeholder="Total Gaji"></div>
